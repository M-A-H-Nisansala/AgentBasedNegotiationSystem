...
public class Order {
	 ...
	 *            The start price
	 */
	public Order(String name, Date deadline, int start, int limit,
			boolean buyorder, IClockService clock) {
		this.name = name;
	...
	public void setName(String name) {
		...
		this.name = name;
		pcs.firePropertyChange("title", oldname, name);
	}
	 ...
	 * 
	 * @return The deadline time. / public void getDeadlineTime() { return }
	 */
	...
	public void setStartTime(long starttime) {
		...
		pcs.firePropertyChange("startTime", new Long(oldstarttime), new Long(
				starttime));
	}
	...
	public void setBuyOrder(boolean buyorder) {
		...
		this.buyorder = buyorder;
		pcs.firePropertyChange("buyOrder", oldbuyorder ? Boolean.TRUE
				: Boolean.FALSE, buyorder ? Boolean.TRUE : Boolean.FALSE);
	}
