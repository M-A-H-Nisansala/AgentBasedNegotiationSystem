...
public class SellerBDI implements IBuyItemService, INegotiationAgent {
	...
	protected void makeProposal(MakeProposal goal) {
		...
		Collections.sort(orders, new Comparator<Order>() {
			public int compare(Order o1, Order o2) {
				double prio1 = (time - o1.getStartTime())
						/ (o1.getDeadline().getTime() - o1.getStartTime());
				double prio2 = (time - o1.getStartTime())
						/ (o1.getDeadline().getTime() - o1.getStartTime());
				return prio1 > prio2 ? 1 : prio1 < prio2 ? -1 : o1.hashCode()
						- o2.hashCode();
			}
		});
	...
	/**
	 * Ask the seller for a a quote on an item.
	 * 
	 * @param name
	 *            The item name.
	 * @return The price.
	...
	public IFuture<Integer> callForProposal(String name) {
		...
		agent.dispatchTopLevelGoal(goal).addResultListener(
